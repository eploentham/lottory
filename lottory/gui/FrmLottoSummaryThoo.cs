...
namespace lottory.gui
{
    public partial class FrmLottoSummaryThoo : Form
    {
        ...
        public void setControl(String yearId, String monthId, String periodId, String saleId, String flag)
        {
            dgv1.Rows.Clear();
            ...
            if (flag.Equals(""))
            {
                dt = lc.lotdb.selectByThooTranfer(yearId, monthId, periodId, saleId);
            }
            else
            {
                dt = lc.lotdb.selectBySale(yearId, monthId, periodId, saleId);
            }
